...
import com.zhangxiaofanfan.cloud.framework.apilog.core.service.ApiAccessLogFrameworkServiceImpl;
import com.zhangxiaofanfan.cloud.framework.apilog.core.service.ApiErrorLogFrameworkService;
import com.zhangxiaofanfan.cloud.framework.apilog.core.service.ApiErrorLogFrameworkServiceImpl;
...
public class ZxffApiLogAutoConfiguration implements WebMvcConfigurer {
    ...
    public ApiAccessLogFrameworkService apiAccessLogFrameworkService(ApiAccessLogApi apiAccessLogApi) {
        log.info("apiAccessLogApi: {}", apiAccessLogApi);
    ...
    public ApiErrorLogFrameworkService apiErrorLogFrameworkService(ApiErrorLogApi apiErrorLogApi) {
        log.info("apiErrorLogApi: {}", apiErrorLogApi);
