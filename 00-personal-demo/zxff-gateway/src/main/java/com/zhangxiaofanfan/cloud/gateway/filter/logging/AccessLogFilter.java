package com.zhangxiaofanfan.cloud.gateway.filter.logging;
...
import com.zhangxiaofanfan.cloud.gateway.filter.grey.GrayReactiveLoadBalancerClientFilter;
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        log.info("过滤器[{}]执行了...", AccessLogFilter.class.getName());
