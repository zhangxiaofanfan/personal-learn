package com.zhangxiaofanfan.cloud.gateway.filter.security;

import cn.hutool.core.util.StrUtil;
import com.fasterxml.jackson.core.type.TypeReference;
import com.google.common.cache.CacheLoader;
import com.google.common.cache.LoadingCache;
import com.zhangxiaofanfan.cloud.framework.common.core.KeyValue;
import com.zhangxiaofanfan.cloud.framework.common.pojo.CommonResult;
import com.zhangxiaofanfan.cloud.framework.common.util.cache.CacheUtils;
import com.zhangxiaofanfan.cloud.framework.common.util.json.JsonUtils;
import com.zhangxiaofanfan.cloud.gateway.filter.logging.AccessLogFilter;
import com.zhangxiaofanfan.cloud.gateway.util.LoginUser;
import com.zhangxiaofanfan.cloud.gateway.util.SecurityFrameworkUtils;
import com.zhangxiaofanfan.cloud.gateway.util.WebFrameworkUtils;
import com.zhangxiaofanfan.cloud.module.system.api.oauth2.OAuth2TokenApi;
...
public class TokenAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private final LoadingCache<KeyValue<Long, String>, LoginUser> loginUserCache =
            CacheUtils.buildAsyncReloadingCache(
                    ...
                    new CacheLoader<>() {
                        @Override
                        public LoginUser load(KeyValue<Long, String> token) throws Exception {
                            return buildUser(checkAccessToken(token.getKey(), token.getValue()).block());
                        }
                    }
            );
    ...
    public Mono<Void> filter(final ServerWebExchange exchange, GatewayFilterChain chain) {
        log.info("过滤器[{}]执行了...", TokenAuthenticationFilter.class.getName());
    ...
    public Mono<String> checkAccessToken(Long tenantId, String token) {
